...
/// L1 Scoring object
class DBOW2_API __SCORING_CLASS(L1Scoring, true, L1);

/// L2 Scoring object
class DBOW2_API __SCORING_CLASS(L2Scoring, true, L2);

/// Chi square Scoring object
class DBOW2_API __SCORING_CLASS(ChiSquareScoring, true, L1);

/// KL divergence Scoring object
class DBOW2_API __SCORING_CLASS(KLScoring, true, L1);

/// Bhattacharyya Scoring object
class DBOW2_API __SCORING_CLASS(BhattacharyyaScoring, true, L1);

/// Dot product Scoring object
class DBOW2_API __SCORING_CLASS(DotProductScoring, false, L1);
